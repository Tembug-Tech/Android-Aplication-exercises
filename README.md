...
Normal Case - Students with valid scores (85, 90, 78, 92, 88)
Empty File - Excel file with only headers, no data
Invalid Scores - Scores below 0 or above 100 (105, -5, 110, -10)
Null/Missing Names - Empty or whitespace-only name fields
Output
